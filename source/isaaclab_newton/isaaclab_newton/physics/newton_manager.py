...
class NewtonManager(PhysicsManager):
    ...
    def clear(cls):
        ...
        NewtonManager._has_loop_joints = False
    ...
    def start_simulation(cls) -> None:
        ...
        NewtonManager._has_loop_joints = False
        _art_start = getattr(cls._model, "articulation_start", None)
        _art_end = getattr(cls._model, "articulation_end", None)
        if _art_start is not None and _art_end is not None:
            ...
            if _art_end_np.shape[0] > 0:
                NewtonManager._has_loop_joints = bool((_art_start_np[1:] > _art_end_np).any())
